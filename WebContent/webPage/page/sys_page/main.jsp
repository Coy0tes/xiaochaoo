...
<head>
	...
	<script type="text/javascript" src="<%=basePath%>/static/index/js/main.js"></script>
</head>
<body class="childrenBody">
	<div class="panel_box row">
		<div class="panel col">
			<a href="javascript:;" data-url="<%=basePath%>/webPage/page/message/message.jsp">
		...
		<div class="panel col">
			<a href="javascript:;" data-url="<%=basePath%>/webPage/page/user/allUsers.jsp">
		...
		<div class="panel col">
			<a href="javascript:;" data-url="<%=basePath%>/webPage/page/img/images.jsp">
		...
		<div class="panel col">
			<a href="javascript:;" data-url="<%=basePath%>/webPage/page/news/newsList.jsp">
		...
		<div class="panel col max_panel">
			<%-- <a href="javascript:;" data-url="<%=basePath%>/webPage/page/news/newsList.jsp"> --%>
			<a href="javascript:;" data-url="/xiaochaoo/path/news/findList">
			<!-- <a href="path/news/findList" > -->
