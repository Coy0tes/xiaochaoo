...
<head>
	...
	<script type="text/javascript" src="<%=basePath%>/webPage/page/links/linksAdd.js"></script>
</head>
<body class="childrenBody">
	<form:form modelAttribute="links" action="/xiaochaoo/path/links/save" method="post" class="layui-form" style="width:80%;" >
		<div class="layui-form-item">
			<label class="layui-form-label">网站名称</label>
			<div class="layui-input-block">
				<form:input path="home" class="layui-input linksName" lay-verify="required" placeholder="请输入网站名称"/>
			</div>
		</div>
		<div class="layui-form-item">
			<label class="layui-form-label">网站地址</label>
			<div class="layui-input-block">
				<form:input path="urls" class="layui-input linksUrl" lay-verify="required|url" placeholder="请输入网站地址"/>
			</div>
		</div>
		<div class="layui-form-item">
			...
			<div class="layui-inline">		
				...
				<div class="layui-input-inline">
					<form:input path="createDate" class="layui-input linksTime" lay-verify="date" onclick="layui.laydate({elem:this})"/>
				</div>
			</div>
		</div>
		<!-- <div class="layui-form-item">
